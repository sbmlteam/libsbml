/**
 * Filename    : ModifierSpeciesReference.c
...
ModifierSpeciesReference_create (void)
{
  ...
  msr = (ModifierSpeciesReference_t *)
        safe_calloc(1, sizeof(ModifierSpeciesReference_t));

  SimpleSpeciesReference_init( (SimpleSpeciesReference_t *) msr,
...
ModifierSpeciesReference_free (ModifierSpeciesReference_t *msr)
{
  ...
  SimpleSpeciesReference_clear((SimpleSpeciesReference_t *) msr);
  safe_free(msr);
}
...
{
  return SimpleSpeciesReference_getSpecies((SimpleSpeciesReference_t *) msr);
}
...
{
  return SimpleSpeciesReference_isSetSpecies((SimpleSpeciesReference_t *) msr);
}
...
ModifierSpeciesReference_setSpecies ( ModifierSpeciesReference_t *msr,
                                      const char *sid )
{
  SimpleSpeciesReference_setSpecies((SimpleSpeciesReference_t *) msr, sid);
}
