...
public class TestReadSBML {
  ...
  public void test_ReadSBML_line_col_numbers()
  {
    ...
    if ( USE_EXPAT == 1 )
    {
      assertTrue( sb.getLine() == 3 );
      assertTrue( sb.getColumn() == 2 );
    }
    if ( USE_LIBXML == 1 )
    {
      assertTrue( sb.getLine() == 3 );
    ...
    {
      assertTrue( sb.getLine() == 3 );
      assertTrue( sb.getColumn() == 42 );
    }
    sb = M.getListOfReactions();
    if ( USE_EXPAT == 1 )
    {
      assertTrue( sb.getLine() == 4 );
      assertTrue( sb.getColumn() == 4 );
    }
    if ( USE_LIBXML == 1 )
    {
      assertTrue( sb.getLine() == 4 );
