#!/usr/bin/env perl
#
# @file   ctest_converter.pl
# @brief  Converts C/C++ libSBML's test files into C#, Java, Python, and Ruby files.
...
$c \$HeadURL\$
$c
$c This test file was converted from src/$cat/test/$ofile
$c with the help of conversion sciprt (ctest_converter.pl).
$c
$c<!---------------------------------------------------------------------------
...
$c
$c Copyright 2005-2008 California Institute of Technology.
