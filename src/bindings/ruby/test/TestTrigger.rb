#
# This file was converted from libsbml/src/sbml/test/TestTrigger.c
...
class TestTrigger < Test::Unit::TestCase
  ...
  def test_Trigger_create
    assert_equal LibSBML::SBML_TRIGGER, @@d.getTypeCode
  ...
  def test_Trigger_createWithMath
    ...
    assert_equal LibSBML::SBML_TRIGGER, fd.getTypeCode
