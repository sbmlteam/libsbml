...
function [found, fhandle] = getFBCDefaultValueFunction(typecode)
  ...
  switch (typecode)
    ...
    case {'SBML_FBC_AND', 'FbcAnd', 'fbcAnd', 'fbc_fbcAnd'}
      fhandle = str2func('getFbcAndDefaultValues');
    case {'SBML_FBC_OR', 'FbcOr', 'fbcOr', 'fbc_fbcOr'}
      fhandle = str2func('getFbcOrDefaultValues');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [SBMLfieldnames, nNumberFields] = getFbcAndDefaultValues(level, ...
                                                       version, pkgVersion)
  if (~isValidLevelVersionCombination(level, version))
    error ('invalid level/version combination');
  end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [SBMLfieldnames, nNumberFields] = getFbcOrDefaultValues(level, ...
                                                       version, pkgVersion)
  if (~isValidLevelVersionCombination(level, version))
    error ('invalid level/version combination');
  end
