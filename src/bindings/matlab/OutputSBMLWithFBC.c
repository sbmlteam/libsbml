...
/**
  ...
  if (fbcPresent == 1)
  {
    SBMLDocument_setPkgRequired(sbmlDocument, "fbc", 1);
			         ...
			         Model_t * sbmlModel )
{
  ...
  double dValue;
	...
	mxArray * mxId, * mxReaction, * mxOperation, * mxValue;
  mxArray *mxInput[1];
  mxArray *mxOutput[1];
  ...
  SBasePlugin_t *plugin = SBase_getPlugin((SBase_t *)(sbmlModel), "fbc");
	...
	for (i = 0; i < nNoFluxBounds; i++) 
	{
  	...
  	/* get sboTerm */
		...
		nStatus = mxGetString(mxReaction, pacReaction, nBuflen);
		...
		nStatus = mxGetString(mxOperation, pacOperation, nBuflen);
			         ...
			         Objective_t * pObjective )
{
  ...
  double dCoefficient;
	...
	mxArray * mxNotes, * mxAnnotations, * mxMetaid, *mxSBOTerm;
	mxArray * mxReaction, * mxCoefficient;
  mxArray *mxInput[1];
  mxArray *mxOutput[1];
