...
%   Totalfail = Totalfail + fail_unless( strcmp( m.compartment(1).fbc_kvp_xmlns, 'http://www.sbml.org/sbml/level3/version1/fbc/version3'             ));
...
%   Totalfail = Totalfail + fail_unless( strcmp( m.species(1).fbc_kvp_xmlns, 'http://www.sbml.org/sbml/level3/version1/fbc/version3'             ));
