...
function [found, fhandle] = getFBCValueFunction(typecode)
    ...
    case {'SBML_FBC_AND', 'FbcAnd', 'fbcAnd', 'fbc_fbcAnd'}
      fhandle = str2func('getFbcAndValueType');
    case {'SBML_FBC_OR', 'FbcOr', 'fbcOr', 'fbc_fbcOr'}
      fhandle = str2func('getFbcOrValueType');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [SBMLfieldnames, nNumberFields] = getFbcAndValueType(level, ...
                                                       version, pkgVersion)
  if (~isValidLevelVersionCombination(level, version))
    error ('invalid level/version combination');
  end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [SBMLfieldnames, nNumberFields] = getFbcOrValueType(level, ...
                                                       version, pkgVersion)
  if (~isValidLevelVersionCombination(level, version))
    error ('invalid level/version combination');
  end
