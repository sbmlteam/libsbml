...
public:
   ...
   * be turned into a single ASTNode of type @c AST_NODE with a value of
   * <code>-4.1</code>, or it can be turned into a node of type @c
   * AST_MINUS having a child node of type @c AST_REAL.  This method lets
   * you tell the parser which behavior to use&mdash;either collapse
   * minuses or always preserve them.  The two possibilities are
