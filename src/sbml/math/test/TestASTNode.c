...
START_TEST (test_ASTNode_getL3Precedence_noargs)
{
  ASTNode_t *n = ASTNode_create();

  ASTNode_setType(n, AST_PLUS);
  fail_unless(ASTNode_getL3Precedence(n) == 8);
...
START_TEST (test_ASTNode_getL3Precedence_onearg)
{
  ASTNode_t *n = ASTNode_create();
  ...
  ASTNode_setType(n, AST_MINUS);
  fail_unless(ASTNode_getL3Precedence(n) == 6); //Different!
...
START_TEST (test_ASTNode_getL3Precedence_twoargs)
{
  ASTNode_t *n = ASTNode_create();
  ASTNode_t *c = ASTNode_create();
  ASTNode_setName(c, "x");
  ...
  ASTNode_setType(n, AST_PLUS);
  fail_unless(ASTNode_getL3Precedence(n) == 4); //Different!

  ASTNode_setType(n, AST_MINUS);
  fail_unless(ASTNode_getL3Precedence(n) == 4); //Different!

  ASTNode_setType(n, AST_TIMES);
  fail_unless(ASTNode_getL3Precedence(n) == 5); //Different!

  ASTNode_setType(n, AST_DIVIDE);
  fail_unless(ASTNode_getL3Precedence(n) == 5); //Different!

  ASTNode_setType(n, AST_POWER);
  fail_unless(ASTNode_getL3Precedence(n) == 7); //Different!
  ...
  ASTNode_setType(n, AST_LOGICAL_AND);
  fail_unless(ASTNode_getL3Precedence(n) == 2); //Different!

  ASTNode_setType(n, AST_LOGICAL_NOT);
  fail_unless(ASTNode_getL3Precedence(n) == 8); //Different!
  ...
  ASTNode_setType(n, AST_RELATIONAL_EQ);
  fail_unless(ASTNode_getL3Precedence(n) == 3); //Different!
...
START_TEST (test_ASTNode_getL3Precedence_threeargs)
{
  ASTNode_t *n = ASTNode_create();
  ASTNode_t *c = ASTNode_create();
  ASTNode_setName(c, "x");
...
START_TEST (test_ASTNode_getL3Precedence_mod)
{
  ASTNode_t *n = SBML_parseL3Formula("(x%1) % sin(j+(3%4))");
  fail_unless( ASTNode_getL3Precedence(n) == 5);
  ASTNode_free(n);
...
START_TEST (test_ASTNode_isTranslatedModulo)
{
  ASTNode_t *n = ASTNode_create();
  ASTNode_t *c = ASTNode_create();

  ASTNode_setType(n, AST_FUNCTION_PIECEWISE);
  fail_unless(!ASTNode_isTranslatedModulo(n));
...
{ 
  ...
  tcase_add_test( tcase, test_ASTNode_getL3Precedence_noargs  );
  tcase_add_test( tcase, test_ASTNode_getL3Precedence_onearg  );
  tcase_add_test( tcase, test_ASTNode_getL3Precedence_twoargs );
  tcase_add_test( tcase, test_ASTNode_getL3Precedence_threeargs);
  tcase_add_test( tcase, test_ASTNode_getL3Precedence_mod     );
  tcase_add_test( tcase, test_ASTNode_hasTypeAndNumChildren   );
  tcase_add_test( tcase, test_ASTNode_isTranslatedModulo      );
