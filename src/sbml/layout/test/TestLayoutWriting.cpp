...
START_TEST (test_LayoutWriting)
{
  ...
  BoundingBox bb=BoundingBox("bb_compartment",10,10,2300,980);
  ...
  bb=BoundingBox("bb_tg_compartment",50,870,300,72);
  ...
  bb=BoundingBox("bb_sg_malate_cyt",580,280,240,36);
  speciesGlyph_malate_cyt->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_malate_cyt");
  bb=BoundingBox("bb_tg_malatate_cyt",590,280,220,36);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_oxaloacetate_cyt",580,480,240,36);
  speciesGlyph_oxaloacetate_cyt->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_oxaloacetate_cyt");
  bb=BoundingBox("bb_tg_oxaloacetate_cyt",590,480,220,36);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_aspartate_cyt",580,680,240,36);
  speciesGlyph_aspartate_cyt->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_aspartate_cyt");
  bb=BoundingBox("bb_tg_aspartate_cyt",590,680,220,36);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_glutamate_cyt",800,610,240,36);
  speciesGlyph_glutamate_cyt->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_glutamate_cyt");
  bb=BoundingBox("bb_tg_glutamate_cyt",810,610,220,36);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_aKetoglutarate_cyt",860,500,280,36);
  speciesGlyph_aKetoglutarate_cyt->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_aKetoglutarate_cyt");
  bb=BoundingBox("bb_tg_aKetoglutarate_cyt",870,500,260,36);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_nad_cyt",520,350,100,24);
  speciesGlyph_nad_cyt->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_nad_cyt");
  bb=BoundingBox("bb_tg_nad_cyt",525,350,80,24);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_nadh_cyt",520,430,100,24);
  speciesGlyph_nadh_cyt->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_nadh_cyt");
  bb=BoundingBox("bb_tg_nadh_cyt",525,430,80,24);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_h_cyt",430,430,40,24);
  speciesGlyph_h_cyt->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_h_cyt");
  bb=BoundingBox("bb_tg_h_cyt",435,430,30,24);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_tg_rg_malaltedh_cyt",700,385,210,24);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_tg_rg_aspartateat_cyt",440,585,260,24);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_malate_mito3",1850,80,240,36);
  speciesGlyph_malate_mito3->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_malate_mito3");
  bb=BoundingBox("bb_tg_malatate_mito3",1860,80,220,36);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_oxaloacetate_mito3",1850,280,240,36);
  speciesGlyph_oxaloacetate_mito3->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_oxaloacetate_mito3");
  bb=BoundingBox("bb_tg_oxaloacetate_mito3",1860,280,220,36);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_aspartate_mito3",1850,480,240,36);
  speciesGlyph_aspartate_mito3->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_aspartate_mito3");
  bb=BoundingBox("bb_tg_aspartate_mito3",1860,480,220,36);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_glutamate_mito3",1550,430,240,36);
  speciesGlyph_glutamate_mito3->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_glutamate_mito3");
  bb=BoundingBox("bb_tg_glutamate_mito3",1560,430,220,36);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_aKetoglutarate_mito3",1530,300,280,36);
  speciesGlyph_aKetoglutarate_mito3->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_aKetoglutarate_mito3");
  bb=BoundingBox("bb_tg_aKetoglutarate_mito3",1540,300,260,36);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_nad_mito3",2050,150,100,24);
  speciesGlyph_nad_mito3->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_nad_mito3");
  bb=BoundingBox("bb_tg_nad_mito3",2055,150,80,24);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_nadh_mito3",2050,230,100,24);
  speciesGlyph_nadh_mito3->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_nadh_mito3");
  bb=BoundingBox("bb_tg_nadh_mito3",2055,230,80,24);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_sg_h_mito3",2200,230,40,24);
  speciesGlyph_h_mito3->setBoundingBox(&bb);

  tg=layout->createTextGlyph();
  tg->setId("TextGlyph_h_mito3");
  bb=BoundingBox("bb_tg_h_mito3",2205,230,30,24);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_tg_rg_malatedh_mito3",1740,185,220,24);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_tg_rg_aspartateat_mito3",1970,385,260,24);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_tg_rg_aspartateCarrier",1380,500,160,24);
  tg->setBoundingBox(&bb);
  ...
  bb=BoundingBox("bb_tg_rg_malateCarrier",1360,330,140,24);
  tg->setBoundingBox(&bb);
