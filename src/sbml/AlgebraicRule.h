 ...
 *
 * Finally, any symbol that appears as the target of a 'rateOf' csymbol may not be determined by an AlgebraicRule.  This is because the 'rateOf' csymbol is defined as applying only to symbols whose rates of change are easily determinable.
 *
