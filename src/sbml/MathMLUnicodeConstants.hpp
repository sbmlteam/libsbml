/**
 * Filename    : MathMLUnicodeConstants.hpp
 * Description : MathML attribute and element names in (Xerces-C) Unicode.
...
#ifndef MathMLUnicodeConstants_hpp
#define MathMLUnicodeConstants_hpp
...
#endif  // MathMLUnicodeConstants_hpp
