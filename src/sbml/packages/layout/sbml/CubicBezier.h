 ...
 *
 * In order to be able to represent smooth curves the &ldquo;layout&rdquo; package defines the class CubicBezier. It represents a Bezier curve, and is readily available in most graphics APIs. 
...
public:
   ...
   *
   * @return the SBML type code for this object: SBMLLayoutTypeCode_t#SBML_LAYOUT_CUBICBEZIER
   *
   * @see getElementName()
   * @see getPackageName()
   */
