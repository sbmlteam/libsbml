...
public:
	 ...
	 */
	virtual const NewASTNode* getMath() const;
	 ...
	 *
	 * @param math; NewASTNode* determining the value of the "resultLevel" attribute to be set.
	 *
	 ...
	 */
	virtual int setMath(NewASTNode* math);
