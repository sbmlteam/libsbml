/**
 * @file:   ArraysSpeciesReferencePlugin.h
...
#ifndef ArraysSpeciesReferencePlugin_H__
#define ArraysSpeciesReferencePlugin_H__
...
class LIBSBML_EXTERN ArraysSpeciesReferencePlugin : public SBasePlugin
{
public:
	 ...
	 */
	ArraysSpeciesReferencePlugin(const std::string& uri, const std::string& prefix, 
	 ...
	 *
	 * @param orig; the ArraysSpeciesReferencePlugin instance to copy.
	 */
	ArraysSpeciesReferencePlugin(const ArraysSpeciesReferencePlugin& orig);
	 ...
	 *
	 * @return a (deep) copy of this ArraysSpeciesReferencePlugin object.
	 */
	virtual ArraysSpeciesReferencePlugin* clone () const;


 	/**
	 * Destructor for ArraysSpeciesReferencePlugin.
	 */
	virtual ~ArraysSpeciesReferencePlugin();
...
#endif /* __cplusplus */
#endif /* ArraysSpeciesReferencePlugin_H__ */
