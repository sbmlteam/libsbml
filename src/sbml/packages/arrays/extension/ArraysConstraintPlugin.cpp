/**
 * @file:   ArraysConstraintPlugin.cpp
 * @brief:  Implementation of the ArraysConstraintPlugin class
...
/*
 * Creates a new ArraysConstraintPlugin
 */
ArraysConstraintPlugin::ArraysConstraintPlugin(const std::string& uri,  
...
/*
 * Copy constructor for ArraysConstraintPlugin.
 */
ArraysConstraintPlugin::ArraysConstraintPlugin(const ArraysConstraintPlugin& orig) :
	  SBasePlugin(orig)
...
/*
 * Assignment operator for ArraysConstraintPlugin.
 */
ArraysConstraintPlugin& 
ArraysConstraintPlugin::operator=(const ArraysConstraintPlugin& rhs)
{
	if (&rhs != this)
	{
...
/*
 * Creates and returns a deep copy of this ArraysConstraintPlugin object.
 */
ArraysConstraintPlugin* 
ArraysConstraintPlugin::clone () const
{
	return new ArraysConstraintPlugin(*this);
}


/*
 * Destructor for ArraysConstraintPlugin.
 */
ArraysConstraintPlugin::~ArraysConstraintPlugin()
{
}
 ...
 */
SBase*
ArraysConstraintPlugin::createObject (XMLInputStream& stream)
{
	SBase* object = NULL; 
 ...
 */
void
ArraysConstraintPlugin::writeElements (XMLOutputStream& stream) const
{
 ...
 */
bool
ArraysConstraintPlugin::hasRequiredElements () const
{
...
ArraysConstraintPlugin::getListOfDimensions () const
{
 ...
 */
ListOfDimensions* 
ArraysConstraintPlugin::getListOfDimensions ()
{
 ...
 */
const Dimension*
ArraysConstraintPlugin::getDimension(unsigned int n) const
{
 ...
 */
Dimension*
ArraysConstraintPlugin::getDimension(unsigned int n)
{
 ...
 */
const Dimension*
ArraysConstraintPlugin::getDimension(const std::string& sid) const
{
 ...
 * Returns the Dimension object based on its identifier.
Dimension*
ArraysConstraintPlugin::getDimension(const std::string& sid)
{
	return static_cast<const Dimension*>(mDimensions.get(sid));
}
 ...
 */
int
ArraysConstraintPlugin::addDimension (const Dimension* dimension)
{
	if (dimension == NULL)
	{
 ...
 */
Dimension* 
ArraysConstraintPlugin::createDimension ()
{
	 Dimension* d = NULL;
 ...
 */
Dimension* 
ArraysConstraintPlugin::removeDimension(unsigned int n)
{
 ...
 */
Dimension* 
ArraysConstraintPlugin::removeDimension(const std::string& sid)
{
 ...
 */
unsigned int 
ArraysConstraintPlugin::getNumDimensions () const
{
 ...
 */
void
ArraysConstraintPlugin::setSBMLDocument(SBMLDocument* d)
{
 ...
 */
void
ArraysConstraintPlugin::connectToParent(SBase* sbase)
{
 ...
 */
void
ArraysConstraintPlugin::enablePackageInternal(const std::string& pkgURI,
