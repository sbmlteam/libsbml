...
#ifndef ArraysReactionPlugin_H__
#define ArraysReactionPlugin_H__
...
class LIBSBML_EXTERN ArraysReactionPlugin : public SBasePlugin
{
public:
	 ...
	 */
	ArraysReactionPlugin(const std::string& uri, const std::string& prefix, 
	 ...
	 *
	 * @param orig; the ArraysReactionPlugin instance to copy.
	 */
	ArraysReactionPlugin(const ArraysReactionPlugin& orig);
	 ...
	 *
	 * @return a (deep) copy of this ArraysReactionPlugin object.
	 */
	virtual ArraysReactionPlugin* clone () const;


 	/**
	 * Destructor for ArraysReactionPlugin.
	 */
	virtual ~ArraysReactionPlugin();
...
#endif /* __cplusplus */
#endif /* ArraysReactionPlugin_H__ */
