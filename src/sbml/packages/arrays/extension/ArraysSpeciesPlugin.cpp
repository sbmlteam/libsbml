 ...
 */
ArraysSpeciesPlugin::ArraysSpeciesPlugin(const std::string& uri,  
 ...
 */
ArraysSpeciesPlugin::ArraysSpeciesPlugin(const ArraysSpeciesPlugin& orig) :
	  SBasePlugin(orig)
 ...
 */
ArraysSpeciesPlugin* 
ArraysSpeciesPlugin::clone () const
{
	return new ArraysSpeciesPlugin(*this);
}
 ...
 */
ArraysSpeciesPlugin::~ArraysSpeciesPlugin()
{
}
 ...
 */
SBase*
ArraysSpeciesPlugin::createObject (XMLInputStream& stream)
{
	SBase* object = NULL; 
 ...
 */
void
ArraysSpeciesPlugin::writeElements (XMLOutputStream& stream) const
{
 ...
 */
bool
ArraysSpeciesPlugin::hasRequiredElements () const
{
...
ArraysSpeciesPlugin::getListOfDimensions () const
{
 ...
 */
ListOfDimensions* 
ArraysSpeciesPlugin::getListOfDimensions ()
{
 ...
 */
const Dimension*
ArraysSpeciesPlugin::getDimension(unsigned int n) const
{
 ...
 */
Dimension*
ArraysSpeciesPlugin::getDimension(unsigned int n)
{
 ...
 */
const Dimension*
ArraysSpeciesPlugin::getDimension(const std::string& sid) const
{
 ...
 * Returns the Dimension object based on its identifier.
Dimension*
ArraysSpeciesPlugin::getDimension(const std::string& sid)
{
	return static_cast<const Dimension*>(mDimensions.get(sid));
}
 ...
 */
int
ArraysSpeciesPlugin::addDimension (const Dimension* dimension)
{
	if (dimension == NULL)
	{
 ...
 */
Dimension* 
ArraysSpeciesPlugin::createDimension ()
{
	 Dimension* d = NULL;
 ...
 */
Dimension* 
ArraysSpeciesPlugin::removeDimension(unsigned int n)
{
 ...
 */
Dimension* 
ArraysSpeciesPlugin::removeDimension(const std::string& sid)
{
 ...
 */
unsigned int 
ArraysSpeciesPlugin::getNumDimensions () const
{
 ...
 */
void
ArraysSpeciesPlugin::setSBMLDocument(SBMLDocument* d)
{
 ...
 */
void
ArraysSpeciesPlugin::connectToParent(SBase* sbase)
{
 ...
 */
void
ArraysSpeciesPlugin::enablePackageInternal(const std::string& pkgURI,
