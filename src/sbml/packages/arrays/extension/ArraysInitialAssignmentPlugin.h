/**
 * @file:   ArraysInitialAssignmentPlugin.h
...
#ifndef ArraysInitialAssignmentPlugin_H__
#define ArraysInitialAssignmentPlugin_H__
...
class LIBSBML_EXTERN ArraysInitialAssignmentPlugin : public SBasePlugin
{
public:
	 ...
	 */
	ArraysInitialAssignmentPlugin(const std::string& uri, const std::string& prefix, 
	 ...
	 *
	 * @param orig; the ArraysInitialAssignmentPlugin instance to copy.
	 */
	ArraysInitialAssignmentPlugin(const ArraysInitialAssignmentPlugin& orig);
	 ...
	 *
	 * @return a (deep) copy of this ArraysInitialAssignmentPlugin object.
	 */
	virtual ArraysInitialAssignmentPlugin* clone () const;


 	/**
	 * Destructor for ArraysInitialAssignmentPlugin.
	 */
	virtual ~ArraysInitialAssignmentPlugin();
...
#endif /* __cplusplus */
#endif /* ArraysInitialAssignmentPlugin_H__ */
