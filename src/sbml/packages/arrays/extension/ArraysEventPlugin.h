...
#ifndef ArraysEventPlugin_H__
#define ArraysEventPlugin_H__
...
class LIBSBML_EXTERN ArraysEventPlugin : public SBasePlugin
{
public:
	 ...
	 */
	ArraysEventPlugin(const std::string& uri, const std::string& prefix, 
	 ...
	 *
	 * @param orig; the ArraysEventPlugin instance to copy.
	 */
	ArraysEventPlugin(const ArraysEventPlugin& orig);
	 ...
	 *
	 * @return a (deep) copy of this ArraysEventPlugin object.
	 */
	virtual ArraysEventPlugin* clone () const;


 	/**
	 * Destructor for ArraysEventPlugin.
	 */
	virtual ~ArraysEventPlugin();
