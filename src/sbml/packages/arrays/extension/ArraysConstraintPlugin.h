...
#ifndef ArraysConstraintPlugin_H__
#define ArraysConstraintPlugin_H__
...
class LIBSBML_EXTERN ArraysConstraintPlugin : public SBasePlugin
{
public:
	 ...
	 */
	ArraysConstraintPlugin(const std::string& uri, const std::string& prefix, 
	 ...
	 *
	 * @param orig; the ArraysConstraintPlugin instance to copy.
	 */
	ArraysConstraintPlugin(const ArraysConstraintPlugin& orig);
	 ...
	 *
	 * @return a (deep) copy of this ArraysConstraintPlugin object.
	 */
	virtual ArraysConstraintPlugin* clone () const;


 	/**
	 * Destructor for ArraysConstraintPlugin.
	 */
	virtual ~ArraysConstraintPlugin();
...
#endif /* __cplusplus */
#endif /* ArraysConstraintPlugin_H__ */
