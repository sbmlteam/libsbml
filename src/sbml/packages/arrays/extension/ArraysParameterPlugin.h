...
#ifndef ArraysParameterPlugin_H__
#define ArraysParameterPlugin_H__
...
class LIBSBML_EXTERN ArraysParameterPlugin : public SBasePlugin
{
public:
	 ...
	 */
	ArraysParameterPlugin(const std::string& uri, const std::string& prefix, 
	 ...
	 *
	 * @param orig; the ArraysParameterPlugin instance to copy.
	 */
	ArraysParameterPlugin(const ArraysParameterPlugin& orig);
	 ...
	 *
	 * @return a (deep) copy of this ArraysParameterPlugin object.
	 */
	virtual ArraysParameterPlugin* clone () const;


 	/**
	 * Destructor for ArraysParameterPlugin.
	 */
	virtual ~ArraysParameterPlugin();
...
#endif /* __cplusplus */
#endif /* ArraysParameterPlugin_H__ */
