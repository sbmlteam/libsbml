...
#ifndef ArraysRulePlugin_H__
#define ArraysRulePlugin_H__
...
class LIBSBML_EXTERN ArraysRulePlugin : public SBasePlugin
{
public:
	 ...
	 */
	ArraysRulePlugin(const std::string& uri, const std::string& prefix, 
	 ...
	 *
	 * @param orig; the ArraysRulePlugin instance to copy.
	 */
	ArraysRulePlugin(const ArraysRulePlugin& orig);
	 ...
	 *
	 * @return a (deep) copy of this ArraysRulePlugin object.
	 */
	virtual ArraysRulePlugin* clone () const;


 	/**
	 * Destructor for ArraysRulePlugin.
	 */
	virtual ~ArraysRulePlugin();
