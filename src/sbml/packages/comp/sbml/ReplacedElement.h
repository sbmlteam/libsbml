 ...
 * Implementation of the %ReplacedElement construct from the &ldquo;comp&rdquo; package.
 *
...
public:
   ...
   *
   * @return the SBML type code for this object: SBMLCompTypeCode_t#SBML_COMP_REPLACEDELEMENT 
   *
   * @see getElementName()
   * @see getPackageName()
   */
