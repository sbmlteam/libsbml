...
class LIBSBML_EXTERN Distribution : public DistribBase
{
protected:
...
public:
   ...
   *
   * @return the value of the "math" element of this Distribution as a
   * ASTNode*.
   */
   ...
   *
   * @return @c true if this Distribution's "math" element has been set,
   ...
   * Distribution have been set, otherwise @c false is returned.
   */
   ...
   *
   *
   * @note The required elements for the Distribution object are:
   */
 ...
 *
 * @param d the Distribution_t structure whose math is sought.
 *
 * @return the value of the "math" element of this Distribution_t as a pointer
 ...
 * @param d the Distribution_t structure.
 *
 * @return @c 1 (true) if this Distribution_t's "math" element has been set,
 ...
 * Distribution_t have been set, otherwise @c 0 (false) is returned.
 *
 * @memberof Distribution_t
 */
LIBSBML_EXTERN
 ...
 *
 *
 * @note The required elements for the Distribution_t object are:
 *
 * @memberof Distribution_t
 */
LIBSBML_EXTERN
