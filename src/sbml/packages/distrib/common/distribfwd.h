...
typedef CLASS_OR_STRUCT PredefinedPDF		PredefinedPDF_t;
typedef CLASS_OR_STRUCT ExplicitPMF		ExplicitPMF_t;
typedef CLASS_OR_STRUCT ExplicitPDF		ExplicitPDF_t;
