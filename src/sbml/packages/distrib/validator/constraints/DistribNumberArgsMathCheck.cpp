 ...
 *
 * @file    DistribNumberArgsMathCheck.cpp
...
#include "DistribNumberArgsMathCheck.h"
 ...
 */
DistribNumberArgsMathCheck::DistribNumberArgsMathCheck (unsigned int id, Validator& v) : MathMLBase(id, v)
{
}
 ...
 */
DistribNumberArgsMathCheck::~DistribNumberArgsMathCheck ()
{
}
...
/*
  ...
  */
void
DistribNumberArgsMathCheck::checkMath(const Model& m, const ASTNode& node, const SBase & sb)
{

  const DistribASTPlugin * astPlugin = dynamic_cast<const DistribASTPlugin*>(node.getPlugin("distrib"));
 ...
 */
const string
DistribNumberArgsMathCheck::getMessage (const ASTNode& node, const SBase& object)
{
