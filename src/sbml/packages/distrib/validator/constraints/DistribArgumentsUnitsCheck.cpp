 ...
 *
 * @file    DistribArgumentsUnitsCheck.cpp
...
#include "DistribArgumentsUnitsCheck.h"
 ...
 */
DistribArgumentsUnitsCheck::DistribArgumentsUnitsCheck (unsigned int id, Validator& v) : ArgumentsUnitsCheck(id, v)
{
}
 ...
 */
DistribArgumentsUnitsCheck::~DistribArgumentsUnitsCheck ()
{
}
...
/*
  ...
  */
void
DistribArgumentsUnitsCheck::checkUnits (const Model& m, const ASTNode& node, const SBase & sb,
...
//  */
//void 
//DistribArgumentsUnitsCheck::checkSameUnitsAsArgs (const Model& m, 
//                                              const ASTNode& node, 
...
// */
//void 
//DistribArgumentsUnitsCheck::logInconsistentSameUnits (const ASTNode & node, 
//                                             const SBase & sb)
//{
