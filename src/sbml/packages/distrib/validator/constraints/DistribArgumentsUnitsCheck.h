 ...
 *
 * @file    DistribArgumentsUnitsCheck.h
...
#ifndef DistribArgumentsUnitsCheck_h
#define DistribArgumentsUnitsCheck_h
...
class DistribArgumentsUnitsCheck: public ArgumentsUnitsCheck
{
public:
   ...
   */
  DistribArgumentsUnitsCheck (unsigned int id, Validator& v);

  /**
   * Destroys this Constraint.
   */
  virtual ~DistribArgumentsUnitsCheck ();
