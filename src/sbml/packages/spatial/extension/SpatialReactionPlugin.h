 ...
 * @brief   Definition of SpatialReactionPlugin, the plugin class of
 *          spatial package for the Species/Reaction element.
 * @author  
 *
 * $Id: SpatialReactionPlugin.h 10673 2010-01-17 07:18:20Z ajouraku $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/branches/libsbml-5/src/packages/spatial/extension/SpatialReactionPlugin.h $
 *
 *<!---------------------------------------------------------------------------
...
#ifndef SpatialReactionPlugin_h
#define SpatialReactionPlugin_h
...
public:
   ...
   * Constructor
   */
	SpatialReactionPlugin (const std::string &uri, const std::string &prefix, SpatialPkgNamespaces *spatialns);
