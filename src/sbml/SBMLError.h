...
typedef enum
{
 ...
 , MultipleAnnotations                   = 10404 /*!< Multiple annotation elements are not allowed */
 ...
 , LevelPositiveInteger                  = 20105 /*!< <code>level</code> must be a positive integer */
 , VersionPositiveInteger                = 20106 /*!< <code>version</code> must be a positive integer */
 ...
 , OneOfEachListOf                       = 20205 /*!< Only one instance of each different <code>listOf___</code> element is allowed */
 , OnlyFuncDefsInListOfFuncDefs          = 20206 /*!< Only FunctionDefinition objects are allowed in ListOfFunctionDefinitions */
 , OnlyUnitDefsInListOfUnitDefs          = 20207 /*!< Only UnitDefinition objects are allowed in ListOfUnitDefinitions */
 , OnlyCompartmentsInListOfCompartments  = 20208 /*!< Only Compartment objects are allowed in ListOfCompartments */
 , OnlySpeciesInListOfSpecies            = 20209 /*!< Only Species objects are allowed in ListOfSpecies */
 , OnlyParametersInListOfParameters      = 20210 /*!< Only Parameter objects are allowed in ListOfParameters */
 , OnlyInitAssignsInListOfInitAssigns    = 20211 /*!< Only InitialAssignment are allowed in ListOfInitialAssignments */
 , OnlyRulesInListOfRules                = 20212 /*!< Only Rule objects are allowed in ListOfRules */
 , OnlyConstraintsInListOfConstraints    = 20213 /*!< Only Constraint objects are allowed in ListOfConstraints */
 , OnlyReactionsInListOfReactions        = 20214 /*!< Only Reaction object are allowed in ListOfReactions */
 , OnlyEventsInListOfEvents              = 20215 /*!< Only Events allowed in ListOfEvents */
 , L3ConversionFactorOnModel             = 20216 /*!< A conversion factor must be a Parameter defined in the model */
 ...
 , OneMathElementPerFunc                 = 20306 /*!< A FunctionDefinition must contain one <code>&lt;math&gt;</code> element */
 , AllowedAttributesOnFunc               = 20307 /*!< A FunctionDefinition must have an <code>id</code> attribute and, optionally, <code>metaid</code> and <code>sboTerm</code> */
 ...
 , OneListOfUnitsPerUnitDef              = 20414 /*!< Only one ListOfUnit object is permitted inside a UnitDefinition */
 , OnlyUnitsInListOfUnits                = 20415 /*!< Only Unit objects are allowed in ListOfUnit */
 ...
 , OneDimensionalCompartmentUnits        = 20511 /*!< No units for 1-D Compartment */
 , TwoDimensionalCompartmentUnits        = 20512 /*!< No units for 2-D Compartment */
 , ThreeDimensionalCompartmentUnits      = 20513 /*!< No units for 3-D Compartment */
 ...
 , ConversionFactorOnSpecies             = 20617 /*!< Invalid conversion factor attribute */
 , AllowedAttributesOnSpecies            = 20623 /*!< Invalid attribute on Species object */
 , InvalidParameterUnits                 = 20701 /*!< Invalid value for attribute <code>units</code> in parameter definition */
 , ParameterUnits                        = 20702 /*!< No units given for Parameter */
 , ConversionFactorMustConstant          = 20705 /*!< A conversion factor must be a constant Parameter defined in the model */
 , AllowedAttributesOnParameter          = 20706 /*!< Invalid attribute given on Parameter object */
 ...
 , ConstantNotValidAttribute             = 99903 /*!< Attribute <code>constant</code> is not supported on this component in SBML Level&nbsp;1 */
 , MetaIdNotValidAttribute               = 99904 /*!< Attribute <code>metaid</code> is not supported in SBML Level&nbsp;1 */
 , SBOTermNotValidAttributeBeforeL2V3    = 99905 /*!< Attribute <code>sboTerm</code> is not available on this component before SBML Level&nbsp;2 Version&nbsp;3 */
