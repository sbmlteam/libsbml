 ...
 * so on.  @endif@if java drawn from a set of static integer constants
 ...
 * XMLError.  Severity levels currently range from informational
 ...
 * <tr><td><code>DelayNeedsValuesFromTriggerTime</code></td><td>Delay requires useValuesFromTriggerTime</td><td class="s-na">N</td><td class="s-na">N</td><td class="s-na">N</td><td class="s-na">N</td><td class="s-na">N</td><td class="s-na">N</td><td class="s-na">N</td></tr>
 ...
 * <tr><td><code>OnlyOnePriorityPerEvent</code></td><td>Event can only have one &lt;priority&gt;</td><td class="s-na">N</td><td class="s-na">N</td><td class="s-na">N</td><td class="s-na">N</td><td class="s-na">N</td><td class="s-na">N</td><td class="s-error">E</td></tr>
