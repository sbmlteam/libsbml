...
class LIBSBML_EXTERN LocalParameter : public SBase
{
public:
   ...
   * 
   * @return @c true if the "id" attribute of this LocalParameter has been
   ...
   * @htmlinclude libsbml-comment-set-methods.html
   * 
   * @return @c true if the "name" attribute of this LocalParameter has been
   * set, @c false otherwise.
   */
   ...
   *
   * @return @c true if the value of this LocalParameter has been set,
   * @c false otherwise.
   *
   * @see getValue()
   *
   ...
   * @htmlinclude libsbml-comment-set-methods.html
   * 
   * @return @c true if the "units" attribute of this LocalParameter has been
   * set, @c false otherwise.
   */
...
class LIBSBML_EXTERN ListOfLocalParameters : public ListOf
{
public:
