 ...
 */
LIBSBML_EXTERN
MathMLDocument::MathMLDocument () : math(NULL)
{
}
...
LIBSBML_EXTERN
bool
MathMLDocument::isSetMath () const
{
  return (math != NULL);
}
...
LIBSBML_EXTERN
void
MathMLDocument::setMath (ASTNode* math)
{
...
{
  return new(std::nothrow) MathMLDocument;
}
...
{
  delete static_cast<MathMLDocument*>(d);
}
...
{
  return static_cast<const MathMLDocument*>(d)->getMath();
}
...
{
  return (int) static_cast<const MathMLDocument*>(d)->isSetMath();
}
...
{
  static_cast<MathMLDocument*>(d)->setMath( static_cast<ASTNode*>(math) );
}
