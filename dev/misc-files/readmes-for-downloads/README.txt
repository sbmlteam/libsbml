...
This is the top-level directory of the libSBML 4.3 release.  Here you
will find the following:

  Mac OS X -- folder of binary installers for Mac OS X systems
  Windows  -- folder of binary installers for Microsoft Windows systems
  Linux    -- folder of binary installers for Linux systems

  libSBML-4.3.0-src.zip      \ source code (only), zip archive
  libSBML-4.3.0-src.tar.gz   / source code (only), gzip'ed tar archive

  libSBML-4.3.0-docs.zip     \ formatted documentation (only) archive
  libSBML-4.3.0-docs.tar.gz  /
