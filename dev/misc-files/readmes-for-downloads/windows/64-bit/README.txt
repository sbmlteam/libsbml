                         l i b S B M L   4.3
      Installers for 64-bit Microsoft Windows operating systems
...
for Microsoft Windows 64-bit systems.  The copies of libSBML contained
here were built using the libxml2 XML parser library.  Here you will
find the following:

  * libSBML-4.3.0-win-x64.exe
  ...
  * libSBML-4.3.0-win-matlab-x64.exe
      ...
      also contained within libSBML-4.3.0-win-x64.exe, so if you
  ...
  * Python
      ...
      interface is also included within libSBML-4.3.0-win-x64.exe, so
