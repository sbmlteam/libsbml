...
for Microsoft Windows 32-bit systems.  The copies of libSBML contained
here were built using the libxml2 XML parser library.  Here you will
find the following:

  * libSBML-4.3.0-win-x86.exe
  ...
  * libSBML-4.3.0-win-matlab-x86.exe
      ...
      also contained within libSBML-4.3.0-win-x86.exe, so if you
  ...
  * Python
      ...
      interface is also included within libSBML-4.3.0-win-x86.exe, so
