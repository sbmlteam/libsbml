; Version No is currently 5.1.0b0
; Check before use


[Setup]
AppName=libSBML MATLAB Interface
AppVerName=MATLAB Interface of libSBML 5.1.0b0
AppPublisher=SBML Team
AppPublisherURL=http://sbml.org
AppSupportURL=http://sbml.org
AppUpdatesURL=http://sbml.org
DefaultDirName={pf}\SBML\libSBML-5.1.0b0-libxml2-x86\bindings\matlab
DefaultGroupName=libSBML-matlab
DisableProgramGroupPage=yes
OutputDir=.\Output
OutputBaseFilename=libSBML-5.1.0b0-win-matlab-x86
...
Root: HKLM; Subkey: Software\SBML\libSBML\MATLAB; ValueType: string; ValueName: Version; ValueData: 5.1.0b0
...
**********************************************************************************************************}
  MsgBox('This setup installs the Windows version of the MATLAB binding of libSBML 5.1.0b0 built using the libxml2 2.7.3 XML Parser library. All the necessary libraries are included. The source code is available as a separate download.', mbInformation, mb_Ok);
 end;
