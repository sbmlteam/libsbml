...
copy /y "%INSTALL_DIR%\bindings\python\src\dist\libsbml-%LIBSBML_VERSION%.win32-py2.5.exe" libSBML-%LIBSBML_VERSION%-win-py2.5-x86.exe
copy /y "%INSTALL_DIR%\bindings\python\src\dist\libsbml-%LIBSBML_VERSION%.win32-py2.6.exe" libSBML-%LIBSBML_VERSION%-win-py2.6-x86.exe
copy /y "%INSTALL_DIR%\bindings\python\src\dist\libsbml-%LIBSBML_VERSION%.win32-py2.7.exe" libSBML-%LIBSBML_VERSION%-win-py2.7-x86.exe
...
echo a | xcopy *.h %DEST_DIR%\win32\include\sbml
cd layout
echo a | xcopy *.h %DEST_DIR%\win32\include\sbml\layout
cd ..
cd ..\math
echo a | xcopy *.h %DEST_DIR%\win32\include\sbml\math
cd ..\common
echo a | xcopy *.h %DEST_DIR%\win32\include\sbml\common
cd ..\compress
echo a | xcopy *.h %DEST_DIR%\win32\include\sbml\compress
cd ..\units
echo a | xcopy *.h %DEST_DIR%\win32\include\sbml\units
cd ..\util
echo a | xcopy *.h %DEST_DIR%\win32\include\sbml\util
cd ..\validator
echo a | xcopy *.h %DEST_DIR%\win32\include\sbml\validator
cd ..\xml
echo a | xcopy *.h %DEST_DIR%\win32\include\sbml\xml
cd ..\annotation
echo a | xcopy *.h %DEST_DIR%\win32\include\sbml\annotation
