...
my %IgnoreTestFunc = (
  ...
  test_XMLOutputStream_accessWithNULL            => 0,
  test_XMLAttributes_accessWithNULL              => 0,
  ...
  test_XMLTriple_accessWithNULL                  => 0,
  ...
  test_XMLError_accessWithNULL                   => 0,
  test_XMLNamespaces_accessWithNULL              => 0,
  test_XMLNode_accessWithNULL                    => 0,
  test_XMLToken_accessWithNULL                   => 0,
