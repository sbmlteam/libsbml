...
cd classes
copy ..\..\..\..\..\..\..\src\bindings\java\java-files\libsbmlj.jar libsbmlj.jar
...
copy ..\..\..\..\..\..\win\bin\libbz2.dll libbz2.dll
copy ..\..\..\..\..\..\win\bin\libiconv.dll libiconv.dll
...
copy ..\..\..\..\..\..\win\bin\libbz2.lib libbz2.lib
copy ..\..\..\..\..\..\win\bin\libiconv.lib libiconv.lib
cd ..
...
cd ..\..\..\..\..\..\..\src\sbml
echo a | xcopy *.h ..\..\dev\utilities\win_installer\libsbml\win64\include\sbml
cd layout
echo a | xcopy *.h ..\..\..\dev\utilities\win_installer\libsbml\win64\include\sbml\layout
cd ..
cd ..\math
echo a | xcopy *.h ..\..\dev\utilities\win_installer\libsbml\win64\include\sbml\math
cd ..\common
echo a | xcopy *.h ..\..\dev\utilities\win_installer\libsbml\win64\include\sbml\common
cd ..\compress
echo a | xcopy *.h ..\..\dev\utilities\win_installer\libsbml\win64\include\sbml\compress
cd ..\units
echo a | xcopy *.h ..\..\dev\utilities\win_installer\libsbml\win64\include\sbml\units
cd ..\util
echo a | xcopy *.h ..\..\dev\utilities\win_installer\libsbml\win64\include\sbml\util
cd ..\validator
echo a | xcopy *.h ..\..\dev\utilities\win_installer\libsbml\win64\include\sbml\validator
cd ..\xml
echo a | xcopy *.h ..\..\dev\utilities\win_installer\libsbml\win64\include\sbml\xml
cd ..\annotation
echo a | xcopy *.h ..\..\dev\utilities\win_installer\libsbml\win64\include\sbml\annotation

rem ****************************
rem The following are hardcoded directory structures


rem win64/include/libxml2

cd C:\libSBML_Dependencies\libxml2-2.7.3\include\libxml
echo a | xcopy *.h C:\libsbml\dev\utilities\win_installer\libsbml\win64\include\libxml2
 
rem win64/include/bzip2

cd C:\libsbml_dependencies\bzip2\include
echo a | xcopy *.h C:\libsbml\dev\utilities\win_installer\libsbml\win64\include\bzip2

rem win64/include/zlib

cd C:\libsbml_dependencies\zlib-1.2.3-source\include
echo a | xcopy *.h C:\libsbml\dev\utilities\win_installer\libsbml\win64\include\zlib

rem win64/include/iconv

cd C:\libsbml_dependencies\libiconv-1.12-source\include
echo a | xcopy *.h C:\libsbml\dev\utilities\win_installer\libsbml\win64\include\iconv

cd C:\libsbml\dev\utilities\win_installer
