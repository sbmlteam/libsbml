...
OutputDir=.\Output
OutputBaseFilename=libSBML-4.3.0-win-x86
...
Source: C:\libsbml_trunk\dev\utilities\win_installer\libsbml\bindings\perl\Libsbml.pm; DestDir: {code:GetPerlLibDir}; Flags: ignoreversion recursesubdirs createallsubdirs; Check: GetPerl
Source: C:\libsbml_trunk\dev\utilities\win_installer\libsbml\bindings\perl\Libsbml.pod; DestDir: {code:GetPerlLibDir}; Flags: ignoreversion recursesubdirs createallsubdirs; Check: GetPerl
Source: C:\libsbml_trunk\dev\utilities\win_installer\libsbml\bindings\perl\Libsbml.dll; DestDir: {code:GetPerlAutoDir}; Flags: ignoreversion recursesubdirs createallsubdirs; Check: GetPerl
...
Filename: "{app}\bindings\python\libSBML-4.3.0-win-py2.5-x86.exe"; Check: GetPython25;
Filename: "{app}\bindings\python\libSBML-4.3.0-win-py2.6-x86.exe"; Check: GetPython26;
Filename: "{app}\bindings\python\libSBML-4.3.0-win-py2.7-x86.exe"; Check: GetPython27;
Filename: "{app}\bindings\matlab\libSBML-4.3.0-win-matlab-x86.exe"; Check: GetMatlab;
