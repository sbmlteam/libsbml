# Microsoft Developer Studio Generated NMAKE File, Based on libsbml_expat.dsp
!IF "$(CFG)" == ""
...
CLEAN :
	...
	-@erase "$(OUTDIR)\libsbml_expat.dll"
	-@erase "$(OUTDIR)\libsbml_expat.exp"
	-@erase "$(OUTDIR)\libsbml_expat.lib"
...
CPP_PROJ=/nologo /MD /W3 /GX /O2 /D "USE_EXPAT" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "LIBSBML_EXPORTS" /Fp"$(INTDIR)\libsbml_expat.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
MTL_PROJ=/nologo /D "NDEBUG" /mktyplib203 /win32 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\libsbml_expat.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=libexpat.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\libsbml_expat.pdb" /machine:I386 /out:"$(OUTDIR)\libsbml_expat.dll" /implib:"$(OUTDIR)\libsbml_expat.lib" 
LINK32_OBJS= \
...
"$(OUTDIR)\libsbml_expat.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN :
	...
	-@erase "$(INTDIR)\XMLStringFormatter.obj"
	-@erase "$(INTDIR)\XMLUtil.obj"
	-@erase "$(OUTDIR)\expat_libsbmlD.dll"
	-@erase "$(OUTDIR)\expat_libsbmlD.exp"
	-@erase "$(OUTDIR)\expat_libsbmlD.ilk"
	-@erase "$(OUTDIR)\expat_libsbmlD.lib"
	-@erase "$(OUTDIR)\expat_libsbmlD.pdb"
...
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /ZI /Od /D "USE_EXPAT" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "LIBSBML_EXPORTS" /Fp"$(INTDIR)\libsbml_expat.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
LINK32=link.exe
LINK32_FLAGS=libexpat.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\expat_libsbmlD.pdb" /debug /machine:I386 /out:"$(OUTDIR)\expat_libsbmlD.dll" /implib:"$(OUTDIR)\expat_libsbmlD.lib" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\AlgebraicRule.obj" \
	"$(INTDIR)\AssignmentRule.obj" \
	"$(INTDIR)\ASTNode.obj" \
...
"$(OUTDIR)\expat_libsbmlD.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
!IF EXISTS("libsbml_expat.dep")
!INCLUDE "libsbml_expat.dep"
!ELSE 
!MESSAGE Warning: cannot find "libsbml_expat.dep"
!ENDIF 
!ENDIF 
