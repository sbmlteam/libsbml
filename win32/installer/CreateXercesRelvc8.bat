...
cd C:\libSBML_Dependencies\xerces-c-3.0.1-x86-windows-vc-8.0\include\xercesc
xcopy C:\libSBML_Dependencies\xerces-c-3.0.1-x86-windows-vc-8.0\include\xercesc C:\libsbml-4\win32\installer\libsbml\win32\include\xercesc /S 
