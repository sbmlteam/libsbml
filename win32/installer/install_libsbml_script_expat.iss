...
DefaultDirName={pf}\SBML\libSBML-3.2.0-expat
DefaultGroupName=libSBML
DisableProgramGroupPage=yes
OutputDir=..\..\..\libsbml_3\win32\installer\Output
OutputBaseFilename=libSBML-3.2.0-win-expat
...
**********************************************************************************************************}
  MsgBox('This setup installs the Windows version of libSBML 3.2.0 built using the Expat XML Parser library version 2.0.0. All the necessary libraries are included. The source code is available as a seperate download.', mbInformation, mb_Ok);
