...
[Files]
Source: C:\libsbml\win32\installer\libsbml_3_expat\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: C:\libsbml\win32\installer\libsbml_3_expat\bindings\python\python24\_libsbml.dll; DestDir: {code:GetPython24Dir}; Check: GetPython24
Source: C:\libsbml\win32\installer\libsbml_3_expat\bindings\python\python25\libsbml.py; DestDir: {code:GetPython25Dir}; Check: GetPython25
...
Root: HKLM; Subkey: Software\SBML\libSBML; ValueType: string; ValueName: Version; ValueData: 3.4.1
...
**********************************************************************************************************}
  MsgBox('This setup installs the Windows version of libSBML 3.4.1 built using the Expat 2.0.1 XML Parser library version 2.0.0. All the necessary libraries are included. The source code is available as a seperate download.', mbInformation, mb_Ok);
