...
copy C:\libsbml_3\src\bindings\matlab\install_for_Win32installers_xerces.m install_Win32.m
...
copy C:\libsbml_3\win32\bin\xerces-c_2D.lib xerces-c_2D.lib
copy C:\libsbml_3\win32\bin\xerces-c_2.lib xerces-c_2.lib
copy C:\libsbml_3\win32\bin\xerces-c_2_7.dll xerces-c_2_7.dll
copy C:\libsbml_3\win32\bin\xerces-c_2_7D.dll xerces-c_2_7D.dll
cd ..
...
copy * C:\libsbml_3\win32\installer\libsbml_3_xerces\win32\include\sbml
cd common
copy * C:\libsbml_3\win32\installer\libsbml_3_xerces\win32\include\sbml\common
cd ..
cd math
copy * C:\libsbml_3\win32\installer\libsbml_3_xerces\win32\include\sbml\math
cd ..
cd util
copy * C:\libsbml_3\win32\installer\libsbml_3_xerces\win32\include\sbml\util
cd ..
cd validator
copy * C:\libsbml_3\win32\installer\libsbml_3_xerces\win32\include\sbml\validator
cd ..
cd xml
copy * C:\libsbml_3\win32\installer\libsbml_3_xerces\win32\include\sbml\xml
cd ..
cd units
copy * C:\libsbml_3\win32\installer\libsbml_3_xerces\win32\include\sbml\units
cd ..
cd annotation
copy * C:\libsbml_3\win32\installer\libsbml_3_xerces\win32\include\sbml\annotation
cd ..
cd layout
copy * C:\libsbml_3\win32\installer\libsbml_3_xerces\win32\include\sbml\layout
cd ..
cd C:\libsbml_3\win32\installer\libsbml_3_xerces
