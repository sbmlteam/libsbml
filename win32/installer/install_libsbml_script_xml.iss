...
[Files]
Source: C:\libsbml-4\win32\installer\libsbml\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs
Source: C:\libsbml-4\win32\installer\libsbml\bindings\java\*; DestDir: {code:GetJavaDir}; Flags: ignoreversion recursesubdirs createallsubdirs; Check: GetJava
Source: C:\libsbml-4\win32\installer\libsbml\bindings\matlab\*; DestDir: {code:GetMatlabDir}; Flags: ignoreversion recursesubdirs createallsubdirs; Check: GetMatlab
Source: C:\libsbml-4\win32\installer\libsbml\bindings\octave\*; DestDir: {code:GetOctaveDir}; Flags: ignoreversion recursesubdirs createallsubdirs; Check: GetOctave
Source: C:\libsbml-4\win32\installer\libsbml\bindings\csharp\*; DestDir: {code:GetCSharpDir}; Flags: ignoreversion recursesubdirs createallsubdirs; Check: GetCSharp
Source: C:\libsbml-4\win32\installer\libsbml\bindings\python\python25\libsbml.py; DestDir: {code:GetPython25Dir}; Check: GetPython25
Source: C:\libsbml-4\win32\installer\libsbml\bindings\python\python25\_libsbml.pyd; DestDir: {code:GetPython25Dir}; Check: GetPython25
Source: C:\libsbml-4\win32\installer\libsbml\bindings\python\python26\libsbml.py; DestDir: {code:GetPython26Dir}; Check: GetPython26
...
Source: C:\libsbml-4\win32\installer\libsbml\win32\lib\libxml2.lib; DestDir: {sys}; Check: GetLibrary
Source: C:\libsbml-4\win32\installer\libsbml\win32\bin\libxml2.dll; DestDir: {sys}; Check: GetLibrary
Source: C:\libsbml-4\win32\installer\libsbml\win32\lib\iconv.lib; DestDir: {sys}; Check: GetLibrary
Source: C:\libsbml-4\win32\installer\libsbml\win32\bin\iconv.dll; DestDir: {sys}; Check: GetLibrary
...
Source: C:\libsbml-4\win32\installer\libsbml\win32\bin\zlib1.dll; DestDir: {sys}; Check: GetLibrary
...
Root: HKLM; Subkey: Software\SBML\libSBML; ValueType: string; ValueName: Version; ValueData: 4.0.0
...
**********************************************************************************************************}
  MsgBox('This setup installs the Windows version of libSBML 4.0.0 built using the libxml2 2.7.3 XML Parser libraries. All the necessary libraries are included. The source code is available as a seperate download.', mbInformation, mb_Ok);
