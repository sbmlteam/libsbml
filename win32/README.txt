...
process and varies depending on the tools used.
If you experience such problems and have cygwin installed you can
use the unix2dos facility on these files to remedy the problem. 
Alternatively email the SBMLTeam and we can send you the unzipped 
files.
