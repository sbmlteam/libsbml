...
main (int argc, char *argv[])
{
  ...
  SBMLReader_setSchemaFilenameL1v1(sr, "C:\\libsbml\\xml-schemas\\sbml\\sbml-l1v1.xsd");
  SBMLReader_setSchemaFilenameL1v2(sr, "C:\\libsbml\\xml-schemas\\sbml\\sbml-l1v2.xsd");
  SBMLReader_setSchemaFilenameL2v1(sr, "C:\\libsbml\\xml-schemas\\sbml\\sbml-l2v1.xsd");
  ...
  if (errors > 0)
  {
    SBMLDocument_printWarnings(d, static_cast<FILE *> stdout);
	SBMLDocument_printErrors  (d, static_cast<FILE *> stdout);
    SBMLDocument_printFatals  (d, static_cast<FILE *> stdout);
  }
